...
Essa é a introdução do seu projeto de pesquisa. A formatação, estruturação e elaboração deste documento seguem as diretrizes estabelecidas no manual de normalização bibliográfica para trabalhos científicos \cite{UEPG2023}.

Você encontrará as referências bibliográfias no arquivo referenciasjabref.bib, que pode ser editado pelo JabRef.

Aqui você deve expor o problema central, indicar a originalidade/contribuição, motivação, justificativa, ilustrar o problema por meio de cenários, problemática.

Deve ter o mínimo de 1 página.
